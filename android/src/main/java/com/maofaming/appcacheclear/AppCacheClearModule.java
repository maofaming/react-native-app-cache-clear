...
public class AppCacheClearModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;
    static public AppCacheClearModule myclearCacheModule;

    public AppCacheClearModule(ReactApplicationContext reactContext) {
        super(reactContext);
